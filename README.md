...
#### 新增功能
1. 新增“日均成本截止日期”选项  
2. 新增选择日期后显示当日日均成本计算物品功能（参考支付宝收益显示图）  
3. 新增可导入“新增页面”物品图标功能  
4. 新增“统计 - 每月 / 每年”滑条拖动功能  
5. 新增“统计 - 分类占比”字体点击跳转功能  

#### 优化
1. 优化 App 图标  
2. 优化“统计 - 每日”滑条拖动效果，可随着滑条拖动自动更新统计面板中的日期显示  
3. 优化分类管理显示页面，可显示该分类下的物品  
4. 优化“统计 - 按日”显示逻辑  

#### 修复
1. 修复点击“记录一次使用”后，提醒中心仍显示已删除提醒内容的问题
### v0.3
